/*
	...
	This version of the calculator implements solutions for ex. 1, 2, and 3
*/
...
double define_const_name(string s, double d) 
{
    if (is_declared(s)) { error(s, " declared twice"); }
...
int main() 
{
    try {
        ...
        define_const_name("pi", (22.0/7.0));  
        define_const_name("g", 9.81);
        define_const_name("k", 1000.0);
